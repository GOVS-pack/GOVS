...
This vignette briefly introduces some typical examples of GOVS to help users get started quickly. Detailes and other functions of GOVS,please see [Tutorial for GOVS](https://govs-pack.github.io/Tutorial/) or [User Manual](https://github.com/GOVS-pack/GOVS/blob/master/GOVS-User-Manual.pdf).<br/><br/>
...
IBD map was constructed of contributions from the parents onto the progeny lines discribed by Liu __et al.__ (Liu _et al._, 2020) based hidden Markov model (HMM) . Here we take chromosome-10 of one offspring as an example.
```{r eval=FALSE,echo=T}
## load example data
data(IBDTestData)
